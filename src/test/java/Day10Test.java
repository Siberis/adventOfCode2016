...
public class Day10Test {
    ...
    public void test1() {
        Day10 d = new Day10();
        String inst = "value 5 goes to bot 2\n" +
    ...
    public void FinalA() {
        ...
        target.add(17);
        target.add(61);
        Assert.assertEquals("118", d.find(data + data2, target));
    }

    @Test
    public void FinalB() {
        Day10 d = new Day10();
        Assert.assertEquals(143153, d.process(data + data2));
    }

    String data = "bot 76 gives low to bot 191 and high to bot 21\n" +
