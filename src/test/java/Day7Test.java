...
public class Day7Test {
    ...
    public void test1() {
        Day7 d = new Day7();
        Assert.assertEquals(true, d.test("abba[mnop]qrst"));
    }

    @Test
    public void test2() {
        Day7 d = new Day7();
        Assert.assertEquals(false, d.test("abcd[bddb]xyyx"));
    }

    @Test
    public void test3() {
        Day7 d = new Day7();
        Assert.assertEquals(false, d.test("aaaa[qwer]tyui"));
    }

    @Test
    public void test4() {
        Day7 d = new Day7();
        Assert.assertEquals(true, d.test("ioxxoj[asdfgh]zxcvbn"));
    }
    @Test
    public void test5() {
        Day7 d = new Day7();
        Assert.assertEquals(true, d.test2("aba[bab]xyz"));
    }
    @Test
    public void test6() {
        Day7 d = new Day7();
        Assert.assertEquals(false, d.test2("xyx[xyx]xyx"));
    }
    @Test
    public void test7() {
        Day7 d = new Day7();
        Assert.assertEquals(true, d.test2("aaa[kek]eke"));
    }
    @Test
    public void test8() {
        Day7 d = new Day7();
        Assert.assertEquals(true, d.test2("zazbz[bzb]cdb"));
    }

    @Test
    public void FinalA() {
        Day7 d = new Day7();
        Assert.assertEquals(110, d.count(data + data2 + data3 + data4));
    }
    @Test
    public void FinalB() {
        Day7 d = new Day7();
